...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('sabsabsa-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'sabsabsa-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'sabsabsa-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'sabsabsa-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'sabsabsa-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'sabsabsa-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'sabsabsa-notes-first-open-hint-v1';
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('sabsabsa-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'sabsabsa-note-draft-';
