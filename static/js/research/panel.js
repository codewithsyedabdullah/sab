...
const _RESEARCH_HINTS = [
  "e.g. Trace Sabsabsa's ten-year journey home from Troy — every island, monster, and detour, and why each one cost him",
...
const _SETTINGS_KEY = 'sabsabsa-research-settings';
const _COLLAPSE_KEY = 'sabsabsa-research-settings-collapsed';
...
function _wireEvents(pane) {
  ...
  pane.querySelector('#research-settings-toggle').addEventListener('click', () => {
    ...
    try { localStorage.setItem('sabsabsa-research-settings-collapsed', _settingsCollapsed ? '1' : '0'); } catch {}
  });
