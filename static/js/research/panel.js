...
const _SETTINGS_KEY = 'sab-research-settings';
const _COLLAPSE_KEY = 'sab-research-settings-collapsed';
...
function _wireEvents(pane) {
  ...
  pane.querySelector('#research-settings-toggle').addEventListener('click', () => {
    ...
    try { localStorage.setItem('sab-research-settings-collapsed', _settingsCollapsed ? '1' : '0'); } catch {}
  });
