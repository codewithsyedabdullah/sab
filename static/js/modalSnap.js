...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'sabsabsa-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'sabsabsa-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('sabsabsa:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
