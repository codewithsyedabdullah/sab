...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'sab-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'sab-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('sab:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
